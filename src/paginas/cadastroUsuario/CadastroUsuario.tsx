            ...
            <Grid item xs={6} alignItems='center'>
                <Box paddingX={10}>
                    <form onSubmit={onSubmit}>
                        ...
                        <TextField value={user.nome} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='nome' label='nome e sobrenome' variant='outlined' name='nome' margin='normal' fullWidth required />
                        ...
                        <TextField onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} value={user.foto} id='foto' label='link da foto' variant='outlined' name='foto' margin='normal' fullWidth required />
