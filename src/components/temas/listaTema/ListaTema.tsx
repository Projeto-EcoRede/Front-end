                ...
                tema.map(tema => (
                    ...
                    <Box m={2}  >
                        <Card variant="outlined" className='cardtema'>
                            <CardContent>
                                <Typography className='tituloTema' gutterBottom>
                                    Tema
                                </Typography>
                            ...
                            <CardActions>
                                <Box display="flex" justifyContent="center" mb={1.5} >
                                    ...
                                    <Link to={`/formularioTema/${tema.id}`} className="text-decorator-none">
                                        <Box mx={1}>
                                            <Button variant="contained" className="btncadtema" size='small' color="primary" >
                                                atualizar
                                            </Button>
                                        </Box>
                                    </Link>
                                    <Link to={`/deletarTema/${tema.id}`} className="text-decorator-none">
                                        <Box mx={1}>
                                            <Button variant="contained" size='small' className="btndeltema">
                                                deletar
                                            </Button>
                                        </Box>
                                    </Link>
